...
export default function DetalheProjeto() {
    ...
    return (
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="w-10">
                <a href={project.github} target="_blank">
                    <svg class="dark:text-gray-400 trasition duration-300 hover:scale-[1.1]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="44" height="44" fill="currentColor" viewBox="0 0 24 24">
